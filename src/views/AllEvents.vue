              ...
              <v-content class="pa-2">
                <v-hover v-slot:default="{ hover }">
                  <v-card class="ma-auto" max-width="350" :elevation="hover ? 24 : 4">
                    ...
                    <v-card-text>
                      <span>{{ get.date1 }} - {{ get.date2 }}</span>
                      <br />
                      <span class="text--primary font-weight-bold font-weight-black">{{ get.ename }}</span>
                      <br />
                      <span class>
                        <span>{{ get.editorData.slice(0, 15) }}</span>
                        <br />
