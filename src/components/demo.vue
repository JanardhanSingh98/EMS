<template>
  <v-data-table :headers="headers" :items="events" sort-by="none">
    <template v-slot:top>
    ...
    <template>
      <v-icon small class="mr-2" @click="editItem(item)" color="primary">edit</v-icon>
...
export default {
  data: () => ({
    tab: null,
    dialog: false,
    keys: ["Entertainment", "Technical", "Game"],
    headers: [
      {
        text: "Event Name",
        align: "left",
